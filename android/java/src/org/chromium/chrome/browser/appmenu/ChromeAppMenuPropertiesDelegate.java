...
public class ChromeAppMenuPropertiesDelegate implements AppMenuPropertiesDelegate {
    ...
    public void prepareMenu(Menu menu) {
        ...
        if (isPageMenu && currentTab != null) {
            ...
            MenuItem offlinePage = menu.findItem(R.id.offline_page_id);
            offlinePage.setVisible(
                    !currentTab.isNativePage() && currentTab.getWebContents() != null);
            offlinePage.setTitle(currentTab.isOfflinePage() ?
                    R.string.menu_load_live_page_for_offline_page :
                    R.string.menu_save_offline_page);
            ...
            requestItem.setVisible(!currentTab.isOfflinePage()
            ...
            menu.findItem(R.id.exit_menu_id).setVisible(
                mActivity.getResources().getBoolean(R.bool.swe_feature_exit_dialog));
