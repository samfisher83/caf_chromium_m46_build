        ...
        if (READ_WRITE_TOGGLE_KEY.equals(preference.getKey())) {
            ...
            if (mCategory.showGeolocationSites()) {
                ...
                sharedPreferences.edit().
                        putBoolean(PrefServiceBridge.WEB_DEFENDER_USER_OVERRIDE, true).apply();
        ...
        if (mCategory.showAllSites()
            ...
            if (mCategory.showPermissionBlockedMessage(getActivity())) {
                ...
                if (mCategory.showGeolocationSites()
                    ...
                    String summary = SmartProtectDetailsPreferences.getSmartProtectString(
                            getResources(), getActivity(), "web_refiner_about_text"
                    );
                    if (TextUtils.isEmpty(summary))
                        globalToggle.setSummaryOn(ContentSettingsResources.
                                getWebRefinerEnabledSummary());
                    else
                        globalToggle.setSummaryOn(summary);
                } else if (mCategory.showWebDefenderSites()) {
                    String summary = SmartProtectDetailsPreferences.getSmartProtectString(
                            getResources(), getActivity(), "web_defender_about_text"
                    );
                    if (TextUtils.isEmpty(summary))
                        globalToggle.setSummaryOn(ContentSettingsResources.
