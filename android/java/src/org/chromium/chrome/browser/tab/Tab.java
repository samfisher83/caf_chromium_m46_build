...
public class Tab implements ViewGroup.OnHierarchyChangeListener,
    ...
    public String getLiveUrlForOfflinePage() {
        return (isOfflinePage()) ? nativeGetLiveUrl(mNativeTabAndroid) : getUrl();
    }

    public void goLive() {
        String liveUrl = nativeGetLiveUrl(mNativeTabAndroid);
        if (liveUrl != null) {
            loadUrl(new LoadUrlParams(liveUrl));
        }
    }
    ...
    private native String nativeGetLiveUrl(long nativeTabAndroid);
