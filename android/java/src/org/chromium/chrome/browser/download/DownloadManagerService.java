...
public class DownloadManagerService extends BroadcastReceiver implements
    ...
    private static final boolean sIsDownloadPathSelectionEnabled =
               CommandLine.getInstance().hasSwitch(SWEBrowserSwitches.DOWNLOAD_PATH_SELECTION);
    ...
    private class EnqueueDownloadRequestTask extends
        ...
        public Boolean doInBackground(Boolean... booleans) {
            ...
            if (DownloadManagerUtils.isExternalMemoryEnough(mDownloadInfo) == false) {
              mErrorId = R.string.swe_downloadpath_not_enough_space;
              return false;
            }
            ...
            try {
                if (notifyCompleted) {
                    ...
                    if (sIsDownloadPathSelectionEnabled)
                        request.setDestinationInExternalPublicDir(
                                                mDownloadInfo.getPreferredFolderForMime(),
